        ...
        <div className="reason-element-container">
          ...
          <div className="text-container">
            ...
            <p className="sub-text">
              ...
              technology, data analysis, and on-site reconnaissance by
              astronauts and rovers.
            </p>
          </div>
        </div>
        ...
        <div className="reason-element-container">
          ...
          <div className="text-container">
            ...
            <p className="sub-text">
              ...
              ever-evolving lunar landscape. These factors can affect the
              track's design and location. We must gather sufficient data to
              determine the most stable and secure course for the race.
            </p>
          </div>
        </div>
        ...
        <div className="reason-element-container">
          ...
          <div className="text-container">
            ...
            <p className="sub-text">
              ...
              layout, ensuring that we utilize the latest innovations for the
              best possible race experience.
            </p>
          </div>
        </div>
        ...
        <div className="reason-element-container">
          ...
          <div className="text-container">
            ...
            <p className="sub-text">
              ...
              We are working diligently to ensure that all stakeholders are on
              the same page before finalizing the track layout.
            </p>
          </div>
        </div>
